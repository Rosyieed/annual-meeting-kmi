                        ...
                        <div class="card-body personal-info">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h5 class="fw-bold mb-0 me-4">
                                    <span class="d-block mb-2">Edit Group</span>
                                    <span class="fs-12 fw-normal text-muted text-truncate-1-line">Please fill in the
                                        details below:</span>
                                </h5>
                            </div>
                            <form action="{{ route('master.groups.update', $group->intGroup_ID) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="txtGroupName" name="txtGroupName"
                                                value="{{ $group->txtGroupName }}" required>
                                        </div>
                                    </div>
                                </div>
