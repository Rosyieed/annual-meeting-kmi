    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">Group Data</h5>
            </div>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Master Data</a></li>
                <li class="breadcrumb-item">Group Data</li>
            </ul>
        </div>
            ...
            <div class="page-header-right-items">
                ...
                <div class="d-flex align-items-center page-header-right-items-wrapper gap-2">
                    ...
                    <div class="btn-group" role="group">
                        <a href="{{ route('master.groups.create') }}" class="btn btn-primary">
                            <i class="feather-plus me-2"></i>
                            <span>Create Group</span>
                        </a>
                        <a href="{{ route('master.groups.restore-index') }}" class="btn btn-secondary">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('master.groups.edit', $group->intGroup_ID) }}">
