...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>@yield('title') | Annual Meeting KMI 2025</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('user-assets/images/logo/Logo.png') }}" />
    <!--! END: Favicon-->
    <!--! BEGIN: Bootstrap CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('admin-assets/vendors/js/dataTables.bs5.min.js') }}">
...
<body>
                ...
                {{-- <div class="row">
                    ...
                    <div class="col-xxl-4">
                        <div class="card stretch stretch-full overflow-hidden">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image avatar-lg rounded p-2">
                                            <img class="img-fluid"
                                                src="{{ asset('admin-assets') }}/images/brand/shopify.png"
                                                alt="" />
                                        </div>
                                        <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image avatar-lg rounded p-2">
                                            <img class="img-fluid"
                                                src="{{ asset('admin-assets') }}/images/brand/app-store.png"
                                                alt="" />
                                        </div>
                                        <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image avatar-lg rounded p-2">
                                            <img class="img-fluid"
                                                src="{{ asset('admin-assets') }}/images/brand/figma.png"
                                                alt="" />
                                        </div>
                                        <div>
                            ...
                            <a href="javascript:void(0);"
                                class="card-footer fs-11 fw-bold text-uppercase py-4 text-center">Full Details</a>
                        </div>
                    </div>
                    <!-- [Total Sales] end !-->
                    <!-- [Mini] start -->
                        ...
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body custom-card-action">
                                ...
                                <div class="row g-2">
                                    <div class="col-4">
                                        <a href="javascript:void(0);"
                                            class="hstack border-gray-5 gap-2 rounded border border-dashed p-2">
                                    ...
                                    <table class="table-hover mb-0 table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset('admin-assets') }}/images/avatar/2.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                                ...
                                                <td>
                                                    <span class="badge text-dark bg-gray-200">Sent</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset('admin-assets') }}/images/avatar/3.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                                ...
                                                <td>
                                                    <span class="badge text-dark bg-gray-200">New</span>
                                                </td>
                                                <td>11/06/2023 10:53</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset('admin-assets') }}/images/avatar/4.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset('admin-assets') }}/images/avatar/5.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                                                ...
                                                <td>
                                                    <span class="badge text-dark bg-gray-200">Returning</span>
                                                </td>
                                                <td>11/06/2023 10:53</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="avatar-image">
                                                            <img src="{{ asset('admin-assets') }}/images/avatar/6.png"
                                                                alt="" class="img-fluid" />
                                                        </div>
                                                        <a href="javascript:void(0);">
                    ...
                    <div class="col-xxl-4">
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body">
                                <!--! BEGIN: [Events] !-->
                                <div class="rounded-3 mb-3 border border-dashed p-3">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex align-items-center gap-3">
                                            <div
                                                ...
                                                <span class="fs-18 fw-bold d-block mb-1">20</span>
                                                <span class="fs-10 fw-semibold text-uppercase d-block">Dec</span>
                                            </div>
                                            <div class="text-dark">
                                                <a href="javascript:void(0);"
                                                    class="fw-bold text-truncate-1-line mb-2">React Dashboard
                                                    Design</a>
                                                <span class="fs-11 fw-normal text-muted text-truncate-1-line">11:30am -
                                                    12:30pm</span>
                                            </div>
                                        </div>
                                        <div class="img-group lh-0 justify-content-start d-none d-sm-flex ms-3">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex align-items-center gap-3">
                                            <div
                                                ...
                                                <span class="fs-18 fw-bold d-block mb-1">30</span>
                                                <span class="fs-10 fw-semibold text-uppercase d-block">Dec</span>
                                            </div>
                                            <div class="text-dark">
                                                <a href="javascript:void(0);"
                                                    class="fw-bold text-truncate-1-line mb-2">Admin Design Concept</a>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex align-items-center gap-3">
                                            <div
                                                ...
                                                <span class="fs-18 fw-bold d-block mb-1">17</span>
                                                <span class="fs-10 fw-semibold text-uppercase d-block">Dec</span>
                                            </div>
                                            <div class="text-dark">
                                                <a href="javascript:void(0);"
                                                    class="fw-bold text-truncate-1-line mb-2">Standup Team Meeting</a>
                                ...
                                <!--! BEGIN: [Events] !-->
                                <div class="rounded-3 mb-2 border border-dashed p-3">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex align-items-center gap-3">
                                            <div
                                                ...
                                                <span class="fs-18 fw-bold d-block mb-1">25</span>
                                                <span class="fs-10 fw-semibold text-uppercase d-block">Dec</span>
                                            </div>
                                            <div class="text-dark">
                                                <a href="javascript:void(0);"
                                                    class="fw-bold text-truncate-1-line mb-2">Zoom Team Meeting</a>
                            ...
                            <a href="javascript:void(0);"
                                class="card-footer fs-11 fw-bold text-uppercase py-4 text-center">Upcomming
                                Schedule</a>
                        </div>
                    </div>
                                ...
                                <div class="mb-3">
                                    <div class="d-flex mb-4 pb-1">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('admin-assets') }}/images/brand/app-store.png"
                                                alt="laravel-logo" class="me-3" width="35" />
                                            <div>
                                        ...
                                        <div class="d-flex flex-grow-1 align-items-center">
                                            <div class="progress w-100 ht-5 me-3">
                                                <div class="progress-bar bg-danger" role="progressbar"
                                    ...
                                    <div class="d-flex mb-4 pb-1">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('admin-assets') }}/images/brand/figma.png"
                                                alt="figma-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="d-flex mb-4 pb-1">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('admin-assets') }}/images/brand/facebook.png"
                                                alt="vue-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="d-flex mb-4 pb-1">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('admin-assets') }}/images/brand/github.png"
                                                alt="react-logo" class="me-3" width="35" />
                                            <div>
                                    ...
                                    <div class="d-flex">
                                        <div class="d-flex w-50 align-items-center me-3">
                                            <img src="{{ asset('admin-assets') }}/images/brand/paypal.png"
                                                alt="sketch-logo" class="me-3" width="35" />
                                            <div>
                    ...
                    <div class="col-xxl-4">
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body custom-card-action">
                                <div class="hstack justify-content-between rounded-3 mb-3 border border-dashed p-3">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image">
                                            <img src="{{ asset('admin-assets') }}/images/avatar/1.png"
                                                alt="" class="img-fluid" />
                                        </div>
                                        <div>
                                ...
                                <div class="hstack justify-content-between rounded-3 mb-2 border border-dashed p-3">
                                    <div class="hstack gap-3">
                                        <div class="avatar-image">
                                            <img src="{{ asset('admin-assets') }}/images/avatar/4.png"
                                                alt="" class="img-fluid" />
    ...
    {{-- <div class="theme-customizer">
        ...
        <div class="customizer-sidebar-wrapper">
            <div
                class="customizer-sidebar-header ht-80 border-bottom d-flex align-items-center justify-content-between px-4">
            ...
            <div class="customizer-sidebar-body position-relative p-4" data-scrollbar-target="#psScrollbarInit">
                <!--! BEGIN: [Navigation] !-->
                <div class="position-relative border-gray-2 theme-options-set mb-5 mt-3 border px-3 pb-3 pt-4">
                    <label
                        class="fs-8 fw-bold text-uppercase text-muted text-spacing-2 border-gray-2 position-absolute rounded-2 options-label border bg-white px-2 py-1"
                        style="top: -12px">Navigation</label>
                    <div class="row g-2 theme-options-items app-navigation" id="appNavigationList">
                        <div class="col-6 single-option text-center">
                            ...
                            <label
                                class="fs-9 fw-bold text-dark text-uppercase text-spacing-1 border-gray-2 w-100 h-100 c-pointer position-relative options-label border py-2"
                ...
                <!--! END: [Navigation] !-->
                <!--! BEGIN: [Header] !-->
                <div class="position-relative border-gray-2 theme-options-set mb-5 mt-3 mt-5 border px-3 pb-3 pt-4">
                    <label
                        class="fs-8 fw-bold text-uppercase text-muted text-spacing-2 border-gray-2 position-absolute rounded-2 options-label border bg-white px-2 py-1"
                ...
                <div class="position-relative border-gray-2 theme-options-set mb-5 mt-3 border px-3 pb-3 pt-4">
                    ...
                    <div class="row g-2 theme-options-items app-skin" id="appSkinList">
                        <div class="col-6 position-relative single-option light-button active text-center">
                        ...
                        <div class="col-6 position-relative single-option dark-button text-center">
                ...
                <!--! END: [Skins] !-->
                <!--! BEGIN: [Typography] !-->
                <div class="position-relative border-gray-2 theme-options-set mb-0 mt-3 border px-3 pb-3 pt-4">
                    <label
                        class="fs-8 fw-bold text-uppercase text-muted text-spacing-2 border-gray-2 position-absolute rounded-2 options-label border bg-white px-2 py-1"
            ...
            <div class="customizer-sidebar-footer ht-60 border-top d-flex align-items-center gap-2 px-4">
